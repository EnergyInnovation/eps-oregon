...
OutputVarsFile = "OutputVarsToExport-jobs.lst" # The name of the file containing a list of variables to be included in the RunResultsFile
...
PotentialPolicies = (
    (True, "Additional LCFS Percentage","Additional LCFS Percentage",[0,0.15],"LCFS"),
    ...
    (True, "Additional Minimum Required EV Sales Percentage[passenger,HDVs]","Additional Minimum Required EV Sales Percentage[passenger,HDVs]",[0,1],"Oregon HDV Rules"),
    (True, "Additional Minimum Required EV Sales Percentage[passenger,motorbikes]","Additional Minimum Required EV Sales Percentage[passenger,motorbikes]",[0,1],"Oregon HDV Rules"),
    (True, "Additional Minimum Required EV Sales Percentage[freight,LDVs]","Additional Minimum Required EV Sales Percentage[freight,LDVs]",[0,1],"Oregon HDV Rules"),
    (True, "Additional Minimum Required EV Sales Percentage[freight,HDVs]","Additional Minimum Required EV Sales Percentage[freight,HDVs]",[0,1],"Oregon HDV Rules"),
    ...
    (True, "Boolean Use Non BAU Capacity Retirement Schedule[nuclear es]","Boolean Use Non BAU Capacity Retirement Schedule[nuclear es]",[0,1],"Nuclear capacity lifetime extension"),
    ...
    (True, "Boolean Use Non BAU RPS Qualifying Resource Definitions","Boolean Use Non BAU RPS Qualifying Resource Definitions",[0,1],"100% Clean Electricity Standard"),
    ...
    (True, "Percent Change in Electricity Imports[hard coal es]","Percent Change in Electricity Imports[hard coal es]",[0,-1],"100% Clean Electricity Standard"),
    (True, "Percent Change in Electricity Imports[petroleum es]","Percent Change in Electricity Imports[petroleum es]",[0,-1],"100% Clean Electricity Standard"),
